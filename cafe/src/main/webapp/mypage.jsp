		    ...
		    <div class="col-md-5 col-lg-4 order-md-last">
		        ...
		        <ul class="list-group mb-3">
		            <% 
		                ...
		                for (Orders order : orderList) {
		                    String foodCode = order.getFood_code();
		                    int cnt = order.getCnt();
		                    orderMap.put(foodCode, orderMap.getOrDefault(foodCode, 0) + cnt);
		                }
		            ...
		            <% } else { 
		                ...
		                for (Map.Entry<String, Integer> entry : orderMap.entrySet()) { 
		                    ...
		                    // 해당 음식의 가격을 가져옴
		                    // 해당 음식의 가격을 가져오기 위한 변수
		                    int foodPrice = 0;
		                    
		                    // orderList를 반복하며 해당 음식 코드에 해당하는 음식 가격을 찾음
		                    for (Orders order : orderList) {
		                        if (order.getFood_code().equals(foodCode)) {
		                            foodPrice = order.getFood().getPrice();
		                            break; // 음식 코드에 해당하는 가격을 찾으면 반복문 종료
		                        }
		                    }
		                    
		                    int totalPrice = totalCnt * foodPrice;
		            ...
		            <li class="list-group-item d-flex justify-content-between lh-sm">
		                <div>
		                    <h6 class="my-0"><%= foodCode %></h6>
		                    <small class="text-body-secondary"><%= totalCnt %>(개)</small>
		                </div>
		            ...
		            <form class="needs-validation" novalidate>
		                <div class="row g-3">
		                    ...
		                    <div class="col-sm-6">
		                        ...
		                        <span class="text-body-secondary" style="float:right;"></span>  
		                        <!--닉네임 설정  -->
