            ...
            <section class="layout-detail">
                <div class="inner">
                    <div class="detail-left">
                        <img src="static/img/mn06.jpg" alt="카라멜 마끼야또">
                    </div>
                    <div class="detail-right">
                        <div class="content-box">
                            <h3>카라멜 마끼야또</h3>
                            <p>Developer Caremel Maccihiato</p>
                            <hr>
                            <p>향긋한 바닐라 시럽과 시원한 우유와 얼음을 넣고 점을 찍듯이 에스프레소를 부은 후 벌집 모양으로 카라멜 드리즐을 올린 달콤한 커피 음료</p>
                            <hr>
                            <div class="nutrition">
                                <h4>제품 영양 정보</h4>
						...
						<div class="btn-box">
                        	<input type="hidden" name="food_code" value="카라멜 마끼야또" />
