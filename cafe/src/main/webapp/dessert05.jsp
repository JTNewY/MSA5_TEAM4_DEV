            ...
            <section class="layout-detail">
                <div class="inner">
                    <div class="detail-left">
                        <img class="img-food" src="static/img/mn05_5.jpg" alt="가나슈케이크">
                    </div>
                    <div class="detail-right">
                        <div class="content-box">
                            <h3>딸기 생크림케이크</h3>
                            <p>Developer Strawberry Fresh Cream Cake</p>
                            <hr>
                        ...
                        <div class="btn-box">
                        	<input type="hidden" name="food_code" value="딸기 생크림케이크" />
