            ...
            <section class="layout-detail">
                <div class="inner">
                    <div class="detail-left">
                        <img class="img-food" src="static/img/mn04_4.jpg" alt="가나슈케이크">
                    </div>
                    <div class="detail-right">
                        <div class="content-box">
                            <h3>꾸덕덕 치즈케이크</h3>
                            <p>Developer Cheese Cake</p>
                            <hr>
                        ...
                        <div class="btn-box">
                        	<input type="hidden" name="food_code" value="꾸덕덕 치즈케이크" />
