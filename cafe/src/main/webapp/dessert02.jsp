            ...
            <section class="layout-detail">
                <div class="inner">
                    <div class="detail-left">
                        <img class="img-food" src="static/img/mn02_2.jpg" alt="가나슈케이크">
                    </div>
                    <div class="detail-right">
                        <div class="content-box">
                            <h3>레드벨벳 케이크</h3>
                            <p>Developer Red Velvet Cream Cheese Cake</p>
                            <hr>
                        ...
                        <div class="btn-box">
                        	<input type="hidden" name="food_code" value="레드벨벳 케이크" />
