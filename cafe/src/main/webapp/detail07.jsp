            ...
            <section class="layout-detail">
                <div class="inner">
                    <div class="detail-left">
                        <img src="static/img/mn07.jpg" alt="흑당라떼">
                    </div>
                    <div class="detail-right">
                        <div class="content-box">
                            <h3>흑당라떼</h3>
                            <p>Developer Black Sugar Latte</p>
                            <hr>
                            <p>밀크 쉐이크 같은 부드럽고 달콤한 바닐라 크림 프라푸치노에 깊은 풍미의 단맛을 가진 흑당시럽이 어우러진 부드럽고 달콤한 프라푸치노</p>
                            <hr>
                            <div class="nutrition">
                                <h4>제품 영양 정보</h4>
						...
						<div class="btn-box">
                        	<input type="hidden" name="food_code" value="흑당라떼" />
