            ...
            <section class="layout-detail">
                <div class="inner">
                    <div class="detail-left">
                        <img src="static/img/mn03.jpg" alt="말차푸치노">
                    </div>
                    <div class="detail-right">
                        <div class="content-box">
                            <h3>말차푸치노</h3>
                            <p>Developer Malcha Puccino</p>
                            <hr>
                            <p>깊고 진한 말차 본연의 맛과 향을
                        ...
                        <div class="btn-box">
                        	<input type="hidden" name="food_code" value="말차푸치노" />
