            ...
            <section class="layout-detail">
                <div class="inner">
                    <div class="detail-left">
                        <img class="img-food" src="static/img/mn07_7.jpg" alt="가나슈케이크">
                    </div>
                    <div class="detail-right">
                        <div class="content-box">
                            <h3>딸기초코 케이크</h3>
                            <p>Developer Strawberry Choco Cream Cake</p>
                            <hr>
                        ...
                        <div class="btn-box">
                        	<input type="hidden" name="food_code" value="딸기초코 케이크" />
